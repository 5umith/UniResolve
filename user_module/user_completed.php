...
// Fetch user info
$userQuery = "SELECT roll_no, name, class, section, sem, profile FROM users WHERE email='$email'";
...
<header>
  ...
  <p>User Dashboard</p>
  <a href="user_signOut.php"><img id="signOut" src="images/signOut-removebg-preview.png" alt="Sign Out"></a>
</header>
    ...
    <table>
      ...
      <tbody>
        ...
        if(mysqli_num_rows($complaintsResult)>0){
            ...
            echo "<tr><td colspan='5' style='color:red;text-align:center;'>No completed complaints found.</td></tr>";
        }
        ?>
      </tbody>
    </table>
