    ...
    if (!preg_match("/^[0-9]+$/", $roll_no)) {
        ...
        if (mysqli_num_rows($check) > 0) {
            ...
            $sql = "INSERT INTO users 
                   ...
                   VALUES ('$roll_no', '$name', '$class', '$section', '$sem', '$email', '$dob', '$password', '$phone', '$profile')";
...
#login a:hover, #homepage a:hover {
...
dob.max = new Date().toISOString().split('T')[0];
    ...
    <p id="login">Already registered?&nbsp;&nbsp;<a href="user_login.php">Login</a></p>
    <p id="homepage"><a  href="/Complaint_Portal/landing.html">Go to Homepage</a></p>
</form>
</div>
