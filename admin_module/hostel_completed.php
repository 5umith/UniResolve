...
$sql = "SELECT * FROM complaints WHERE category='Hostel' AND status='Completed' ORDER BY complaint_id DESC";
...
<title>Hostel Completed Complaints</title>
<style>
  * {
...
<div class="container">
  ...
  <div class="contentSection">
    <p>Hostel - Completed Complaints</p>
    <table>
      <tr>
        <th>ID</th>
        <th>User Name</th>
