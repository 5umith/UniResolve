...
$sql = "SELECT * FROM complaints WHERE category='Hostel' AND status='Pending' ORDER BY complaint_id DESC";
...
<title>Hostel Pending Complaints</title>
<style>
 * {
