...
<head>
  ...
  <style>
    ...
    * {
      ...
      /* Apply globally to include padding in width calculations */
    }
  ...
  width: 15vh; */
    ...
    .card {
      ...
      /* max-width: 19vw; */
      height: 14vh;
      /* reduced from 22vh/1vh/12vh/70px etc */
      width: 160px;
      display: flex;
      justify-content: center;
      flex-direction: column;
      ...
      <div class="category">
        ...
        <div class="cardContainer">
          <div class="card" onclick="window.location.href='academic_completed.php'">
            <img src="images/docFinal-removebg-preview.png" alt="">Completed<br>Complaints
          </div>
          <div class="card" onclick="window.location.href='academic_pending.php'">
            <img src="images/docFinal-removebg-preview.png" alt="">Pending<br>Complaints
          </div>
        </div>
      </div>
