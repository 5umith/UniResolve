...
$sql = "SELECT * FROM complaints WHERE category='Canteen' AND status='Completed' ORDER BY complaint_id DESC";
...
<title>Canteen Completed Complaints</title>
<style>
* {
...
<div class="container">
  <div class="sideBar">
    ...
    <div class="sidebarButton">
      ...
      <!-- <a href="canteen_completed.php" class="active">Canteen Complaints</a> -->
  ...
  <div class="contentSection">
    <p>Canteen - Completed Complaints</p>
    <table>
      <tr>
        <th>ID</th>
        <th>User Name</th>
