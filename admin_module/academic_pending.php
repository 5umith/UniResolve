...
// Fetch pending academic complaints
$sql = "SELECT * FROM complaints WHERE category='Academic' AND status='Pending' ORDER BY complaint_id DESC";
...
<title>Academic Pending Complaints</title>
<style>
 * {
...
<header>
  ...
  <p>Admin Dashboard</p>
  <a href="ad_signout.php"><img id="signOut" src="images/signOut-removebg-preview.png" alt="Sign Out" ></a>
</header>
...
<div class="container">
  <div class="sideBar">
    ...
    <div class="sidebarButton">
      ...
      <!-- <a href="academic_pending.php" class="active">Academic Complaints</a> -->
  ...
  <div class="contentSection">
    <p>Academic - Pending Complaints</p>
    <table>
      <tr>
        <th>ID</th>
        <th>User Name</th>
...
const closeBtnView = document.querySelector('.closeBtn');
...
const closeBtnSolution = solutionModal.querySelector('.closeBtn');
    ...
    fetch('', { method:'POST', body:formData })
        ...
        .then(data => {
            if(data.trim() === 'success'){
                ...
                document.querySelector(`button.solutionBtn[data-id='${id}']`).closest('tr').cells[2].textContent = document.getElementById('solutionText').value;
            } else {
