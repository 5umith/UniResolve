...
$query = "SELECT * FROM admin  WHERE dept_email  = '$dept_email '";
...
<div class="container">
    ...
    <div class="sideBar">
        <div class="profileImg">
            <img src="images/dept_admin.png" alt="User Profile">
            <p><?php echo htmlspecialchars($user['deptad_name']); ?></p>
        </div>
    ...
    <div class="profileSection">
        ...
        <p><strong>Department Admin Name:</strong> <?php echo htmlspecialchars($user['deptad_name']); ?></p>
        ...
        <p><strong>Department Email:</strong> <?php echo htmlspecialchars($user['dept_email']); ?></p>
        <p><strong>Department Password:</strong> <?php echo str_repeat("*", strlen($user['dept_password'])); ?></p>
