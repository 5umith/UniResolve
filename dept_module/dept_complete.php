...
// Fetch completed complaints for this department
$complaintsResult = mysqli_query($conn, "SELECT * FROM complaints WHERE category='$department' AND status='Completed' ORDER BY complaint_id DESC");
...
<title>Completed Complaints - <?php echo htmlspecialchars($department); ?></title>
<style>
  * {
    ...
    <table>
      ...
      <tbody>
        ...
        if(mysqli_num_rows($complaintsResult)>0){
            ...
            echo "<tr><td colspan='6'>No completed complaints found.</td></tr>";
        }
        ?>
      </tbody>
    </table>
...
<div id="complaintModal" class="modal">
  <div class="modal-content">
    <h3   style="color: white; font-size:x-large; text-align:center;">Complaint Details</h3>
