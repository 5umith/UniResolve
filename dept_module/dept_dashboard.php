...
$stmt = $conn->prepare("SELECT deptad_name, department FROM admin WHERE dept_email = ?");
...
// Example: get completed/pending tasks for this department (replace with real queries)
// $completedTasks = 5;
// $pendingTasks = 2;
...
<div class="container">
  ...
  <div class="sideBar">
    <div class="profileImg">
      <img src="images/dept_admin.png" alt="Profile">
      <p><?php echo htmlspecialchars($deptad_name); ?></p>
    </div>
    <div class="sidebarButton">
      <a href="dept_dashboard.php" class="active">Dashboard</a><br>
  ...
  <div class="complaintSection">
    <div class="card" onclick="window.location.href='dept_complete.php'">
      <img src="images/docFinal-removebg-preview.png" alt="Completed">
      <span>Completed<br>Complaints</span>
    </div>
    <div class="card" onclick="window.location.href='dept_pending.php'">
      <img src="images/docFinal-removebg-preview.png" alt="Pending">
